    ...
    public static class VentPatches
    {
        ...
        { 
            ...
            if (player.Is(RoleEnum.Engineer) || (player.roleAssigned && playerInfo.Role?.Role == RoleTypes.Engineer) ||
                ...
                (player.Is(RoleEnum.Pestilence) && CustomGameOptions.PestVent) || (player.Is(RoleEnum.Jester) && CustomGameOptions.JesterVent) || (player.Is(RoleEnum.Arsonist)) || (player.Is(RoleEnum.Executioner)) || (player.Is(RoleEnum.Cannibal)))
                return true;
