...
namespace BetterTownOfUs.ImpostorRoles.GrenadierMod
{
    ...
    {
        public static Sprite FlashSprite => BetterTownOfUs.FlashSprite;
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            if (role.FlashButton == null)
            {
                ...
                role.FlashButton.GetComponent<AspectPosition>().DistanceFromEdge = BetterTownOfUs.ButtonPosition;
