...
namespace BetterTownOfUs.ImpostorRoles.SwooperMod
{
    ...
    {
        public static Sprite SwoopSprite => BetterTownOfUs.SwoopSprite;
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            if (role.SwoopButton == null)
            {
                ...
                role.SwoopButton.GetComponent<AspectPosition>().DistanceFromEdge = BetterTownOfUs.ButtonPosition;
