...
namespace BetterTownOfUs {
    ...
    {
        private static Sprite Sprite => BetterTownOfUs.ToUBanner;
        static void Postfix(PingTracker __instance) {
            ...
            iconrenderer.sprite = Patches.ClientOptions.HorseEnabled ? BetterTownOfUs.HorseEnabledImage : BetterTownOfUs.HorseDisabledImage;
