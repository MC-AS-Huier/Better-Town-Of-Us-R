...
namespace BetterTownOfUs.Modifiers.AssassinMod
{
    ...
    {
        private static Sprite CycleBackSprite => BetterTownOfUs.CycleBackSprite;
        private static Sprite CycleForwardSprite => BetterTownOfUs.CycleForwardSprite;

        private static Sprite GuessSprite => BetterTownOfUs.GuessSprite;
        private static Sprite EraseSprite => BetterTownOfUs.EraseToggleSprite;
        private static Sprite KillSprite => BetterTownOfUs.AssassinToggleSprite;
