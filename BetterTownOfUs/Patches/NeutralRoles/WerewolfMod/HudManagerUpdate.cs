...
namespace BetterTownOfUs.NeutralRoles.WerewolfMod
{
    ...
    {
        public static Sprite RampageSprite => BetterTownOfUs.RampageSprite;
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            if (role.RampageButton == null)
            {
                ...
                role.RampageButton.GetComponent<AspectPosition>().DistanceFromEdge = BetterTownOfUs.ButtonPosition;
                role.RampageButton.gameObject.SetActive(false);
            }
