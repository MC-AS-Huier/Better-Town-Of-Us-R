...
using BetterTownOfUs.CrewmateRoles.SnitchMod;
using BetterTownOfUs.CrewmateRoles.TrapperMod;
...
namespace BetterTownOfUs.NeutralRoles.AmnesiacMod
{
    ...
    public class PerformKillButton
    {
        ...
        public static void Remember(Amnesiac amneRole, PlayerControl other)
        {
            ...
            //Reinitialisation du nombre de fix par game quand amnesiac
            /*
            ...
            */
            ...
            else if (other.Is(RoleEnum.Cannibal))
            {
                var role2 = Role.GetRole<Cannibal>(other);
                role2.RegenTask();
            }
            else
            {
