...
namespace BetterTownOfUs.CrewmateRoles.SwapperMod
{
    [HarmonyPatch(typeof(MeetingHud), nameof(MeetingHud.Start))]
    public class AddButton
    {
        private static int _mostRecentId;
        private static Sprite ActiveSprite => BetterTownOfUs.SwapperSwitch;
        public static Sprite DisabledSprite => BetterTownOfUs.SwapperSwitchDisabled;
