    ...
    public static class Patches
    {
        ...
        private class OptionsMenuBehaviour_Start
        {
            ...
            private static Sprite GetSettingSprite(int index)
            {
                ...
                {
                    default:
                        return BetterTownOfUs.SettingsButtonSprite;
                    case 0:
                        return BetterTownOfUs.SettingsButtonSprite;
                    case 1:
                        return BetterTownOfUs.CrewSettingsButtonSprite;
                    case 2:
                        return BetterTownOfUs.NeutralSettingsButtonSprite;
                    case 3:
                        return BetterTownOfUs.ImposterSettingsButtonSprite;
                    case 4:
                        return BetterTownOfUs.ModifierSettingsButtonSprite;
                }
            }
        }
